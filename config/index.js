export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx0cf1080b366fbad7",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9f42b7d30594b77fe44f28a257139593",
  ...
  USERS: [

    {
      ...
      customizedDateList: ["keyword": "birth_day", date: "2004-09-14"
        // 在一起的日子
    ...
    {
      name: "二蛋",
      id: "oocpj6mSBxQz5JPDld6CgKkB8hDo",
      useTemplateId: "早安",
      province: "福建",
      city: "漳州",
      horoscopeDate: '12-02',
